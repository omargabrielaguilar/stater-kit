<li class="flex items-start gap-4 not-first:pt-2.5">
  <img src="{{ $item->profile->avatar }}" alt="{{ $item->profile->display_name }}"
  ...
  <div class="grow pt-1.5">
    <div class="border-eyes-care-light/10 border-b pb-5">
      ...
      <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          ...
          <p class="text-eyes-care-light/40 text-xs">{{ $item->posted_ago }}</p>
          <p>
      ...
      <div class="border-eyes-care-light/10 bg-eyes-care-light/[3%] mt-8 flex items-start gap-4 border-t p-4">
        ...
        'fieldName' => 'reply',
        'placeholder'=> "Reply to {$item->profile->display_name}'s post",
        'rows' => 5,
        ])
      </div>
    </div>
    ...
    <ol>
      ...
      <li class="group/li relative flex items-start gap-4 pt-4">
        <!-- Line-through -->
        <div aria-hidden="true" class="bg-eyes-care-light/10 absolute top-0 left-5 h-full w-px group-last/li:h-4">
        </div>
        ...
        <div class="border-eyes-care-light/10 grow border-b pt-1.5 pb-5">
          <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-2.5">
              ...
              <p>
                <a class="text-eyes-care-light/40 hover:text-eyes-care-light/60 text-xs" href="/profile">@simonswiss</a>
              </p>
            </div>
            <button class="group flex gap-0.75 py-2" aria-label="Post options">
              <span class="bg-eyes-care-light/40 group-hover:bg-eyes-care-light/60 size-1"></span>
